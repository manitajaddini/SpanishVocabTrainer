...
describe('openai client', () => {
    ...
    it('retries prompt generation before succeeding', async () => {
        ...
        const prompt = await generatePrompt({ lemma: 'hablar', languages: { source: 'English', target: 'Spanish' } }, { apiKey: 'secret' });
    ...
    it('returns evaluation payload', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('/api/evaluate', expect.objectContaining({
